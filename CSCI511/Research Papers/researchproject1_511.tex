...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\smallskip
			\\I am an avid PC gamer, this machine is built to handle some pretty aggressive PC games.  I also stream (play games online so people can watch), So I need a little extra horsepower when gaming to allow me to crunch the video encoding as well as push the video to the streaming service and still play games at the same time.  I am also an aspiring coder, some of the AI programming I am currently working on requires extra horsepower to really chew on the data I feed it.
